    ...
    class Program
    {
        static void Main(string[] args)
        {
            /*Now that you've created your Item class, it's time to create some instances of that class to populate your shop's inventory.
                    ...
                    Take a close look at the Shop class and see what the Inventory is made of.Now that you have Item objects, make sure those are in the
                    correct format to go into the Inventory of your shop.
